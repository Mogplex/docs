...
<Cards>
  ...
  <Card
    ...
    description="Launcher flags, env-var escape hatches, config.toml layers, and where on-disk state lives."
  />
  <Card
  ...
  <Card
    ...
    description="Use AGENTS.md, agent.json, project command templates, and permissions files to make Mogplex behave like part of the repo."
  />
</Cards>
