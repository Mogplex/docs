...
| Needs scripted, headless access to Mogplex | Use the [CLI's automation surface](/cli/automation) (`mogplex run`, `mogplex runs events --follow`) or the [v1 REST API](/reference/api) directly. Both ship today. |
