...
[MCP server](/extend/mcp-server) instead.
...
workflows. They do not drive the TUI. The [MCP server](/extend/mcp-server) gives
...
- [MCP server](/extend/mcp-server) — direct programmatic access to Mogplex
