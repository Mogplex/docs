---
title: MCP tools
description: Reference the repo, sandbox, automation, model, log, and agent-run tools exposed by the Mogplex MCP endpoint.
---
...
For exact arguments, limits, and direct JSON-RPC examples, use the
[Mogplex MCP endpoint reference](/web/api/mcp).
