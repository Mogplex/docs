...
- did the task use the intended Worktree and checkout?
...
When isolated coding used a Worktree, compare its task, Sandbox binding,
branch, and checkout path. Use
[Control Execution Environments](/guides/control-execution-environments) when
the selected resource is wrong.
