...
| [External MCP server catalog API](/web/api/mcp-servers) | CLI or scripts read your configured external MCP servers | Sync cloud MCP definitions into local agent hosts. |
...
<Cards>
  ...
  <Card title="External MCP server catalog API" href="/web/api/mcp-servers" />
