...
description: Configure REST and MCP connections, understand scope resolution, sync cloud MCP servers to the CLI, and avoid confusing inbound tools with the Mogplex MCP preview.
---
