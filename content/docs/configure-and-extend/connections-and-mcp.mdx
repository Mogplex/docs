...
The team's `connections.create` capability still controls access to these tools.
...
Saved-server discovery in workspace chat also uses an eight-second startup budget.
