...
which of the memories and agent skills loaded for a request it needed. Those
judgments need short excerpts of commands, tool output, and the agent's final
message, plus your request with the memories and skill summaries loaded for
it. Secrets are removed before anything is sent or stored.
