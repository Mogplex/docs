...
A Sandbox API record represents compute. It does not represent a Control
Worktree and does not imply that a task checkout exists. The public v1 API does
not currently expose Worktree lifecycle routes. See
