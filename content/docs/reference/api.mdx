...
MCP JSON-RPC errors use protocol codes instead of the REST envelope. The most
important codes are `-32700` parse error, `-32600` invalid request, `-32601`
method not found, `-32602` invalid tool arguments, `-32001` unauthorized,
`-32002` rate limited, and `-32003` forbidden origin.
