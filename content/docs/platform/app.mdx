---
title: Mogplex App
description: Use the Mogplex app for setup, routing, Control sessions, Sandbox compute, Worktree checkouts, reusable agents, and inspection.
---
...
| [Worktrees](/web/worktrees) | Planned task checkouts, branches, Sandbox bindings, Diff, Rebase, Archive, and Prune |
...
- a Control worker needs an isolated task checkout or uses the wrong Worktree
...
<Cards>
  <Card title="Projects, Sandboxes, and Worktrees" href="/platform/projects-and-sandboxes" />
