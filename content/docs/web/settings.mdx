...
runs as a local command inside sandboxes and the CLI; see
[Presets that run next to your code](/configure-and-extend/connections-and-mcp#presets-that-run-next-to-your-code). Settings
