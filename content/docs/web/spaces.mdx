---
title: Projects
description: Use Projects at /spaces to organize repos, launch Sandbox compute, open workspace sessions, and enter Control with the correct repository context.
---
...
- A **sandbox** is the runtime and preview environment attached to that repo
  work.
- A **worktree** is a separate task checkout inside selected Sandbox compute.
  Starting the Sandbox does not create one.
...
After a workspace opens in Control, use [Worktrees](/web/worktrees) only for
planned coding tasks that need isolated checkouts. Preview and command requests
use the selected Sandbox without a Worktree.
...
when you need to choose between Sandbox compute and a task Worktree.
...
- [Worktrees](/web/worktrees) explains task, branch, checkout, and Sandbox
  binding after Control delegates isolated coding work.
